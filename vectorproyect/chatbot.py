...
class mi_robot:
    ...
    def hablar(self,sonido):
        ...
        with anki_vector.Robot(args.serial) as robot:
            ...
            audio="/home/pi/Desktop/vector/vectorproyect/audios/"+sonido1
    ...
    def chatbot(self,texto):
        ...
        if " " in audio:
            audio=audio.replace(" ","")
        if "{}.wav".format(audio) in os.listdir("/home/pi/Desktop/vector/vectorproyect/audios"):
        ...
        while "paco" in texto_llamada:
            ...
            try:
                ...
                if "vete a tu casa" in texto:
                    ...
                    if "{}.wav".format(nombre) in os.listdir("/home/pi/Desktop/vector/vectorproyect/audios"):
